...
export const VirEnv_50: Readonly<any> = {
  overlayCoords: [
    [0.00122050900900901,0.00306341071428571],			
    [0.00277634234234234,0.00306341071428571],			
    [0.00277634234234234,0.00200638399280576],			
    [0.00122050900900901,0.00200638399280576],												
  ],
  bounds: [
    [0.00111072072072072 - 0.0005, 0.00190088129496403 - 0.0015], // Southwest coordinates (lng,lat)
    [0.00291252252252252 + 0.0005, 0.00303908928571429 + 0.0005], // Northeast coordinates (lng,lat)
...
export const VirEnv_51: Readonly<any> = {
  overlayCoords: [
    [0.00121715315315315,0.0030530625],			
    [0.00278230630630631,0.0030530625],			
    [0.00278230630630631,0.00200293165467626],			
    [0.00121715315315315,0.00200293165467626],											
  ],
  bounds: [
    [0.00111072072072072 - 0.0005, 0.00190088129496403 - 0.0015], // Southwest coordinates (lng,lat)
    [0.00291252252252252 + 0.0005, 0.00303908928571429 + 0.0005], // Northeast coordinates (lng,lat)
...
// Unity terrain origin: (0.1359863, 0.09790039), size: 440.4167 x 531.4167 meters.
export const VirEnv_52: Readonly<any> = {
  overlayCoords: [
    [0.0000012251018018018, 0.00474566607491071],
    [0.00396894311981982, 0.00474566607491071],
    [0.00396894311981982, 0.000000874110625],
    [0.0000012251018018018, 0.000000874110625],
  ],
  bounds: [
    [0.0000012251018018018 - 0.002, 0.000000874110625 - 0.0035], // Southwest coordinates (lng,lat)
    [0.00396894311981982 + 0.002, 0.00474566607491071 + 0.002], // Northeast coordinates (lng,lat)
  ],
};
